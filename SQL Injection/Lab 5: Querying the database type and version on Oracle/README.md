Ta xác định được có 2 trường dữ liệu, đề bài là hệ thống Oracle SQL nên ta sử dụng truy vấn phù hợp với hệ thống Orcacle: **' UNION SELECT BANNER, NULL FROM v$version--**
